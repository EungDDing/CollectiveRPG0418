...
public class CollectiveGame : ScriptableObject
{
	...
	public List<MissionData_Entity> MissionData; // Replace 'EntityType' to an actual type that is serializable.
	public List<SkillData_Entity> SkillData; // Replace 'EntityType' to an actual type that is serializable.
}
